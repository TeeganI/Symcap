...
#Export Image
pdf(file="Figure 6", width = 6, height = 4)
par(oma=c(3,3,0,0))
...
legend("bottomleft", legend=c("Brown-C", "Orange-C", "Brown-D", "Orange-D"), fill = c("royalblue3", "cornflowerblue", "red", "rosybrown2"), bg = "white")

par(new=T, mar=c(11,18,0,0))
