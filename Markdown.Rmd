...
prop.table(results, margin = 2)
par(mar=c(4, 4, 2, 6))
barplot(prop.table(results, margin = 2), col = c(alpha("blue", 0.75), alpha("red", 0.75)), xlab = "Color Morph", ylab = "Dominant Symbiont Proportion")
legend("topright", legend=c("C", "D"), fill=c(alpha("blue", 0.75), alpha("red", 0.75)), inset = c(-.2, 0), xpd = NA)
```